...
<html lang="zxx">
<head>
    <title>Dev Mobiles | Forgot Page</title>
                ...
                <div class="login-register-area">
                    ...
                    <h5>Reset your password and Fill below details.</h5>
                                                        ...
                                                        <div class="form-box__single-group">
                                                          <input type="text" class="form-control" name="email" placeholder="Enter Your Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  required="true">
                                                        </div>
                                                        <div class="form-box__single-group">
                                                         <input type="text" class="form-control" name="contactno" placeholder="Contact Number" required="true" pattern="[0-9]+">
                                                        </div>
                                                        <div class="form-box__single-group">
                                                          <input type="password" class="form-control" id="userpassword" name="newpassword" minlength="8" placeholder="New Password">
                                                        </div>
                                                        <div class="form-box__single-group">
                                                          <input type="password" class="form-control" id="userpassword" name="confirmpassword" minlength="8" placeholder="Confirm Password">
                                                        </div>
                                                       <br>
