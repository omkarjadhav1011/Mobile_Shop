                    ...
                    <div class="col-xl-4 col-lg-12 col-12">
                        ...
                        <div class="footer__form">
                            ...
                            <form action="#" class="footer__form-box" method="post">
                                <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Your email address">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12 col-12">
                        <div class="footer__copyright-text">
                            <p style="color:red;font-size: 20px;text-align: center;">Dev Mobile Shop @2023</p>
                        </div>
                    </div>
