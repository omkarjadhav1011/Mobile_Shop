        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
$ret=mysqli_query($con,"select tblreview.ID,tblreview.ProductID,tblreview.ReviewTitle,tblreview.Name,tblreview.DateofReview,tblproducts.ProductName from tblreview join tblproducts on tblproducts.ID=tblreview.ProductID where tblreview.Status='Review Accept'");
$cnt=1;
