...
<html lang="zxx">
<head>
    <title>Dev Mobiles | Login Page</title>
   ...
   <!-- ::::::  Start  Breadcrumb Section  ::::::  -->
    ...
    echo $msg;
                                                        ...
                                                        <div class="form-box__single-group">
                                                            <input type="text" name="emailcont" required="true" placeholder="Registered Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="true">
                                                        </div>
                                                        <div class="form-box__single-group">
    ...
    echo $msg;
                                                        ...
                                                        <div class="form-box__single-group">
                                                            <input type="text" placeholder="First Name" name="firstname" pattern="^[a-zA-Z]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$" required="true">
                                                        </div>
                                                        <div class="form-box__single-group">
                                                            <input type="text"  name="lastname" pattern="^[a-zA-Z]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$" placeholder="Last Name" required="true">
                                                        </div>
                                                        <div class="form-box__single-group">
                                                            <input type="text"  name="mobilenumber" required="true" maxlength="10" pattern="[0-9]{10}" placeholder="Mobile Number" required="true">
                                                        </div>
                                                        <div class="form-box__single-group">
                                                            <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Email address" pattern="" required="true">
                                                        </div>
                                                        <div class="form-box__single-group m-b-20">
                                                            <input type="password" name="password" minlength="8" placeholder="Password" required="true">
                                                        </div>
                                                        <div class="form-box__single-group m-b-20">
                                                            <input type="password" name="repeatpassword" minlength="8" placeholder="Repeat password" required="true">
                                                        </div>
