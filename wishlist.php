                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="modal__product-price m-tb-15"> ₹ 599</span>
                        ...
                        <div class="col-md-6 modal__border">
                            ...
                            <ul class="modal__product-shipping-info m-tb-15">
                                <li>Total products:<span> ₹ 9499</span></li>
                                <li>Total shipping:<span> ₹ 300</span></li>
                                <li>Taxes:<span> ₹ 0.00</span></li>
                                <li>Total: <span> ₹ 9799 (tax excl.)</span></li>
                            </ul>
