...
<head>
    <title>Dev Mobiles||Checkout Page</title>
    <!-- Vendor CSS Files -->
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                                <div class="form-box__single-group">
                                    ...
                                    <input type="text" id="zipcode" class="form-control" pattern="[1-9][0-9]{5}" maxlength="6" name="zipcode" required="true">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-box__single-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-box__single-group">
                                    ...
                                    <input type="email" id="form-email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" name="email">
                                </div>
                            </div>
                        </div>
