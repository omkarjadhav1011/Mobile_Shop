                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <div class="hero hero-slider hero---2">
                        <div class="swiper-wrapper">
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2 swiper-slide" style="background-image: url(assets/img/hero/s1.jpg);">
                            ...
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2  swiper-slide" style="background-image: url(assets/img/hero/s2.jpg);">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                            ...
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2 swiper-slide" style="background-image: url(assets/img/hero/s3.jpg);">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                                ...
                                <div class="cms__content">
                                    ...
                                    <div class="cms__text">
                                        ...
                                        <span class="cms__des">For all oders over Rs49</span>
                                    </div>
                                </div>
